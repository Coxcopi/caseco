	...
	if (!class_exists('Plugin')){
		class Plugin{
			...
			function addEvent($event, $callback) {
				global $aseco;
				$aseco->registerEvent($event, $callback);
			}
			function addChatCommand($command, $description) {
				global $aseco;
				$aseco->addChatCommand($command, $description);
			}
		}
	}
}
...
class FufiWidgets extends Plugin {
	 ...
	 * @return String The requested block in a String
	 */
	 ...
	 * @param mixed $records
	 * @param int $ctuCount
	 * @return array a specialized array
	 */
	 ...
	 * @return String The manialink string
	 */
	...
	function chat_togglewidgets($command){
...
if (IN_XASECO){
	...
	$_PLUGIN->addChatCommand('togglewidgets', 'Toggles the display of the record widgets');
}
